...
export function ProgramsPage() {
  const webDevelopmentModules = [
    {
      ...
      description: "Maîtrisez les frameworks et librairies modernes pour construire de belles interfaces utilisateur",
      skills: ["TailwindCSS", "React JS", "Contrôle de Version (Git)"],
      duration: "2 mois",
    },
    {
      icon: Smartphone,
      title: "Responsive Web Design",
      description: "Créez des interfaces utilisateurs qui s'adaptent parfaitement aux différentes tailles d'écran",
      skills: ["HTML5 & CSS3","Media Queries","CSS Grid et Flexbox" ,"Optimisation des performances"],
      duration: "2 mois",
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      skills: ["Animations CSS", "Transitions JavaScript", "Scroll driven Animation", "Performance"],
      duration: "2 semaines",
    },
  ];
  ...
  const digitalSkillsModules = [
    ...
    },
    {
      ...
      skills: ["Design Graphique", "Reseaux Sociaux", "Présentations", "Supports Imprimés"],
      duration: "1 Mois",
    },
    {
      icon: Lightbulb,
      ...
      skills: ["Prompt Engineering", "Génération d'Images", "Codage Assisté par IA", "Vibe Code"],
      duration: "1 Mois",
    },
    {
      icon: Settings,
